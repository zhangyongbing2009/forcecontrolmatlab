function varargout = ExperimentalForce(action,MatData,stress)
%EXPERIMENTALFORCE experimental material for force method
% varargout = ExperimentalForce(action,MatData,stress)
%
...
switch action
   ...
   case 'initialize'
      ...
      dataSizes = int32([0 0 0 ndf 0, ndf 0 0 ndf 0, dataSize]);
   ...
   case 'getStrain'
      ...
      TCPSocket('sendData',socketID(tag),sData,dataSize);
      rData = TCPSocket('recvData',socketID(tag),dataSize);
      stressM = rData(ndf+1:2*ndf);
      
      varargout = {strainT,stressM};
   % ======================================================================
   case 'getTangent'
      varargout = {1/E};
   % ======================================================================
