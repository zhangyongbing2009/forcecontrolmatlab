function varargout = BiLinearHystericForce(action,MatData,stress)
%BILINEARHYSTERICFORCE bilinear-elastic material for force method
% varargout = BiLinearHystericForce(action,MatData,stress)
%
